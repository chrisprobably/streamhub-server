...
public class EndToEndFramework {
	private static final int STREAMING_SERVER_PORT = 8888;
	...
	private static final String HOSTNAME = "localhost.stream-hub.com";
	private static final int SELENIUM_PORT = 4444;
	private static final int WAIT_FOR_INTERVAL = 50;
	private static final int WAIT_FOR_TIMEOUT = 7000;
	private static final EndToEndFramework INSTANCE = new EndToEndFramework();
	...
	public static EndToEndFramework getInstance() {
		return INSTANCE;
	}
	...
	public static void main(String[] args) throws Exception {
		EndToEndFramework framework = EndToEndFramework.getInstance();
		try {
